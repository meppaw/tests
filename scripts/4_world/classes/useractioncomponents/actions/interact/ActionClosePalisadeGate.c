class ActionClosePalisadeGate: ActionInteractBase
{
	void ActionClosePalisadeGate()
	{
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		if ( targetObject && targetObject.CanUseConstruction() )
		{
			...
			if ( gate && gate.CanCloseGate() && ( selection == "left_door_interact" || selection == "right_door_interact" || selection == "door_interact" || selection == "att_combinationlock") )
			{
				return true;
			}
		}
