class CraftR22RStandaloneStaircaseBlueprint extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Draw a Staircase Blueprint";
		...
		//result1
		AddResult("R22R_Standalone_Staircase_Kit");//add results here
