class CraftBBS_WoodenlogStorageKit extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Draw a Wooden Log Storage Blueprint";
		...
		//result1
		AddResult("R22R_BBS_WoodenlogStorage_Kit");//add results here
