class ConstructR22RBasicHalfWallKit extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Draw a Basic Defense Half Wall Blueprint";
		...
		//ingredient 2
		InsertIngredient(1,"Pen_ColorBase");
		...
		//result1
		AddResult("R22R_Basic_Defense_Half_Wall_Kit");//add results here
